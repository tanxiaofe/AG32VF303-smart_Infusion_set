...
/*定义步进电机控制*/
#define A_ON  {GPIO_SetHigh(MOTOR_IN4_GPIO,MOTOR_IN4_PORT);}
#define A_OFF {GPIO_SetLow(MOTOR_IN4_GPIO,MOTOR_IN4_PORT);}

#define B_ON  {GPIO_SetHigh(MOTOR_IN3_GPIO,MOTOR_IN3_PORT);}
#define B_OFF {GPIO_SetLow(MOTOR_IN3_GPIO,MOTOR_IN3_PORT);}

#define C_ON  {GPIO_SetHigh(MOTOR_IN2_GPIO,MOTOR_IN2_PORT);}
#define C_OFF {GPIO_SetLow(MOTOR_IN2_GPIO,MOTOR_IN2_PORT);}

#define D_ON  {GPIO_SetHigh(MOTOR_IN1_GPIO,MOTOR_IN1_PORT);}
#define D_OFF {GPIO_SetLow(MOTOR_IN1_GPIO,MOTOR_IN1_PORT);}
